...
def secure_session_config(app) -> None:
    ...
    if not app.secret_key:
        ...
        app.logger.warning(
            "Generated random secret key. Set SECRET_KEY env var for production."
        )
...
def check_rate_limit(
    identifier: str, max_requests: int = 10, window_seconds: int = 60
) -> bool:
    """
    ...
    if key not in current_app._rate_limits:
        current_app._rate_limits[key] = {"count": 1, "first_request": now}
        return True
