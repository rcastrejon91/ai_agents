...
class SelfLearningEngine:
    ...
    def _extract_trigger(self, message: str) -> str:
        ...
        # Remove common words
        stop_words = {"the", "a", "an", "is", "are", "was", "were", "what", "how", "why", "when"}
    ...
    def _identify_topics(self, history: List[Dict]) -> List[str]:
        ...
        # Topic keywords
        topic_keywords = {
            "medical": ["health", "medical", "doctor", "medicine", "supplement", "nad+"],
    ...
    def _analyze_sentiment(self, history: List[Dict]) -> Dict:
        ...
        positive_words = ["good", "great", "excellent", "thanks", "helpful", "love", "perfect"]
        negative_words = ["bad", "wrong", "error", "problem", "issue", "confused", "frustrated"]
        ...
        return {
            ...
            "score": (sentiment_counts["positive"] - sentiment_counts["negative"]) / max(len(sentiments), 1)
        }
    ...
    def _optimize_responses(self, history: List[Dict]) -> List[str]:
        ...
        for turn in history:
            ...
            self.response_quality[response_key] = min(1.0, self.response_quality[response_key] + 0.05)
