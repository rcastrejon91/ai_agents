      ...
      messages: [
        {
          role: "system",
          content:
            "Classify law updates: output JSON only with keys: domain(therapy_ai|privacy|crisis|ai_disclosure), status(allowed|restricted|prohibited), summary, effective_date(YYYY-MM-DD), sources[{title,url}]}",
        },
