...
async def main() -> None:
    ...
    metrics_samples = [
        {"timeOnPage": 120, "pageViews": 3, "timeOfDay": 23, "dayOfWeek": 5, "location": 2, "deviceType": 2, "returningVisitor": 1},
        {"timeOnPage": 45, "pageViews": 2, "timeOfDay": 9, "dayOfWeek": 1, "location": 6, "deviceType": 1, "returningVisitor": 0},
    ]
